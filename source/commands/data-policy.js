...
module.exports = new CommandWrapper(mainId, "Get a link to the Prophets of the Labyrinth Data Policy page", null, false, [InteractionContextType.BotDM, InteractionContextType.Guild, InteractionContextType.PrivateChannel], 3000,
	...
	(interaction) => {
		interaction.reply({ content: "Here's a link to the Prophets of the Labyrinth Data Policy page (automatically updated): https://github.com/Imaginary-Horizons-Productions/Prophets-of-the-Labyrinth/wiki/Data-Policy", flags: [MessageFlags.Ephemeral] });
	}
);
