...
module.exports = {
	...
	deckOfCardsMisfortune: (variantName) => ({ name: "Misfortune", stacks: { description: "a random amount between 2 and 9", calculate: (user) => 2 + user.roundRns[`${variantName}${SAFE_DELIMITER}Deck of Cards`][0] } }),
