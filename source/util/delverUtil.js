...
function levelUp(delver, levels, adventure) {
	delver.level += levels;
	const { maxHPGrowth, powerGrowth, speedGrowth, critRateGrowth, staggerCapGrowth } = getArchetype(delver.archetype);
	...
	delver.staggerCap += staggerCapGrowth * levels * growthBonus;
}
