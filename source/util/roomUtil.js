...
function spawnEnemy(enemyTemplate, adventure) {
	const enemy = new Enemy(enemyTemplate.name, enemyTemplate.element, enemyTemplate.power ?? 0, enemyTemplate.speed, enemyTemplate.poiseExpression, enemyTemplate.critRate, enemyTemplate.firstAction, { ...enemyTemplate.startingModifiers }, adventure.delvers.length);
