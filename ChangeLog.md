...
- Added `/guild-draft`, which allows players to draft Archetypes and Pets to add to their Guild
- Combined Archetype, Pet, and Starting Artifact selects into the Customize Loadout modal
